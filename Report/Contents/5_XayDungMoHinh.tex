...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/Model_Diagram.png}{
        \includegraphics[width=0.7\linewidth]{Images/Model_Diagram}
    }{
        \fbox{\begin{minipage}{0.7\linewidth}
            \centering
            \vspace{2cm}
            [IMAGE PLACEHOLDER]\\
            \texttt{Images/Model\_Diagram}\\
            \vspace{2cm}
        \end{minipage}}
    }
    \caption{Sơ đồ hệ thống Dual Ensemble (XGBoost + Isolation Forest)}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/Weight_Sensitivity.png}{
        \includegraphics[width=0.7\linewidth]{Images/Weight_Sensitivity}
    }{
        \fbox{\begin{minipage}{0.7\linewidth}
            \centering
            \vspace{2cm}
            [IMAGE PLACEHOLDER]\\
            \texttt{Images/Weight\_Sensitivity}\\
            \vspace{2cm}
        \end{minipage}}
    }
