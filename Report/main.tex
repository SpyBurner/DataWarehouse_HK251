...
\begin{titlepage}
	...
	\begin{center}
		\begin{tabular}{c}
			...
			\\
			\\
			\textbf{\LARGE GAME THẺ BÀI ĐỐI KHÁNG}\\
			\textbf{\LARGE ỨNG DỤNG TRÍ TUỆ NHÂN TẠO}\\
	...
	\begin{table}[h]
		...
		\begin{tabular}{lll} % Using 'c' for the first column (for better alignment of the empty cell)
			\multicolumn{3}{l}{\textbf{\Large HỘI ĐỒNG:} {\Large Hội đồng 13L Đồ án chuyên ngành}}\\
			\\
			\multicolumn{3}{l}{\textbf{\Large CTHĐ:} {\Large TS. Lê Thanh Vân}}\\
			\\
			\multicolumn{3}{l}{\textbf{\Large GVHĐ:} {\Large ThS. Vương Bá Thịnh}}\\
			\\
			\multicolumn{3}{l}{\textbf{\Large TKHĐ:} {\Large ThS. Trần Ngọc Bảo Duy}}\\
			\\
			\multicolumn{3}{l}{\textbf{\Large Sinh viên thực hiện:}} 
			\\
			\\
			& {\Large Nguyễn Huỳnh Hải Đăng} & {\Large 2210737} % Removed parentheses
			\\
			\\
			& {\Large Nguyễn Hiệp Tài} & {\Large 2212985} % Removed parentheses
			\\
			\\
			& {\Large Võ Ngọc Tú} & {\Large 2213857} % Removed parentheses
		\end{tabular}
	\end{table}
	\vspace{0.5cm}
	\begin{center}
...
\begin{center}
	\begin{tabularx}{\textwidth}{c l c X c}
		...
		\midrule
		1 & Nguyễn Huỳnh Hải Đăng & 2210737 &
		Thiết kế luật chơi, xây dựng cốt truyện, thiết kế graphic asset và hiện thực các thành phần Unity Client &
		100\% \\
		
		2 & Nguyễn Hiệp Tài & 2212985 &
		Thiết kế luật chơi, xây dựng cốt truyện, thiết kế giao diện và hiện thực kiến trúc Unity Client &
		100\% \\
		
		3 & Võ Ngọc Tú & 2213857 &
		Thiết kế luật chơi, xây dựng cốt truyện, thiết kế và hiện thực Backend Server, xây dựng API, triển khai hệ thống &
		100\% \\
		\bottomrule
	\end{tabularx}
\end{center}
...
%%%%%%%%%%%%%%%%%CONTENTS%%%%%%%%%%%%%%%%%%%
\input{Contents/1_NguonGocDuLieu.tex}
\newpage
\input{Contents/2_Datawarehouse.tex}
\newpage
\input{Contents/3_TienXuLyDuLieu.tex}
\newpage
\input{Contents/4_FeatureEngineering.tex}
\newpage
\input{Contents/5_XayDungMoHinh.tex}
\newpage
\input{Contents/6_DuBaoTuongLai.tex}
\newpage
\input{Contents/7_DanhGia.tex}
\newpage
