...
\fancyfoot[L]{\scriptsize Báo cáo Bài tập lớn - HK252}
...
\renewcommand\paragraph{\@startsection{subsubsubsection}{4}{\z@}%
...
\begin{titlepage}
	...
	\begin{center}
		\begin{tabular}{c}
			...
			\\{\textbf{\Large VÀ HỆ HỖ TRỢ QUYẾT ĐỊNH}}

			\\\textbf{\LARGE HỆ THỐNG PHÁT HIỆN BẤT THƯỜNG }
			\\\textbf{\LARGE TRÊN NỀN TẢNG STEAM}
		\end{tabular}
	\end{center}
	\vspace{0.5cm}
	\begin{table}[h]
\centering
\begin{tabular}{lll} 
\multicolumn{3}{l}{\textbf{Giáo viên hướng dẫn:} { Bùi Tiến Đức}}\\
\\
\multicolumn{3}{l}{\textbf{Lớp:} {L01}}\\
\\
...
\subsection*{Danh sách thành viên \& đóng góp}
...
\begin{center}
	\begin{tabularx}{\textwidth}{c l c X c}
		...
		Thiết kế Datawarehouse, Pipeline ETL & 
		100\% \\
		\bottomrule
	\end{tabularx}
